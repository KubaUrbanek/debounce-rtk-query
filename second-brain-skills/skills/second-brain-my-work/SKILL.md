...
6. Synthesize results by topic by meaningful outcomes, not by individual commit. Distinguish merged work, work in progress and alternative approaches. Only include explicit tasks/next steps; invent no obligations.
